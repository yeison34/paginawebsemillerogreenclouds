...
import Publicaciones from "../participaciones/Publicaciones.js";
import Eventos from "../participaciones/Eventos.js";

function Generalparticipacionespublicaciones() {
  return (
    <>
...
export default Generalparticipacionespublicaciones;
